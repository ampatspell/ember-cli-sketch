...
export const position = (target, opts) => attr(target, assign({ type: 'number', decimals: 8 }, opts));
export const x = opts => position('x', opts);
export const y = opts => position('y', opts);

export const size = (target, opts) => attr(target, assign({ type: 'number', min: 0, decimals: 8 }, opts));
